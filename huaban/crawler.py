...
class HuabanCrawler():
    ...
    def __init__(self):
        ...
        self.homeUrl = "http://huaban.com/boards/29442728/"
        self.images = []
        self.save_path  = "/mnt/hgfs/vmshare/crawler/huaban"
    ...
    def __process_data(self, htmlPage):
        """ 从html页面中提取图片的信息 """
        #与http://huaban.com/favorite/beauty页面到解析是不同的
    ...
    def down_images(self):
        ...
        for key, image in enumerate(self.images):
            ...
            try:
                ...
                print 'error'
            imageName = os.path.join(self.save_path, image["id"] + "." + image["type"])
            self.__save_image(imageName, req.content)


if __name__ == '__main__':
    hc = HuabanCrawler()
    hc.get_image_info(4000)
    hc.down_images()
